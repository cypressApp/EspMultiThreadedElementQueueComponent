...
const string WifiInfoClass::ESP_AP_WIFI_PASS = "123456789"; 
const string WifiInfoClass::DEVICE_MAC_ADDRESS_STR = "C0428A15753C";
const string WifiInfoClass::ESP_AP_WIFI_SSID = "CYPRESS_ADC_15753C";
const string WifiInfoClass::ROUTER_SSID = "GalaxyA35";
const string WifiInfoClass::ROUTER_PASS = "Majid4321";

esp_netif_t *p_netif;

uint32_t WifiInfoClass::get_device_ip_info_int(){
...
uint32_t WifiInfoClass::get_gateway_ip_info_int(){
...
void WifiInfoClass::get_gateway_ip_info_array(int *array , uint32_t gateway_ip){
...
void WifiInfoClass::update_wifi_mode_ip(int tempIpSlice){
...
void WifiInfoClass::init_mac_address(){
    ...
    // sprintf(esp_wifi_ap_ssid, "%s%.2X%.2X%.2X" , ESP_AP_WIFI_SSID_KEY , 
    //         device_mac_address[3], device_mac_address[4], device_mac_address[5]);
}


int WifiInfoClass::get_ip4(char *addr_str , int len){
